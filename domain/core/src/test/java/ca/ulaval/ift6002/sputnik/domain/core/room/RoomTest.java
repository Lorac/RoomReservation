...
public class RoomTest {
    ...
    private static final String GOOD_ROOMNUMBER = "GOOD_NUMBER";
    private static final String BAD_ROOMNUMBER = "BAD_NUMBER";
    ...
    public void setUp() {
        ...
        room = new StandardRoom(goodRoomNumber, HIGH_CAPACITY_ROOM);
        anotherRoom = new StandardRoom(badRoomNumber, LOW_CAPACITY_ROOM);
    }
